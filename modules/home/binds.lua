...
hl.bind("SUPER + CTRL + H", hl.dsp.workspace.move_to_monitor({ direction = "l" }))
hl.bind("SUPER + CTRL + J", hl.dsp.workspace.move_to_monitor({ direction = "d" }))
hl.bind("SUPER + CTRL + K", hl.dsp.workspace.move_to_monitor({ direction = "u" }))
hl.bind("SUPER + CTRL + L", hl.dsp.workspace.move_to_monitor({ direction = "r" }))
